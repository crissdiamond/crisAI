...
- **Agents** (Publisher, intranet-to-context workflows, etc.) should write new curated artefacts here, mirroring the folder names you expect in `knowledge/` (`patterns/`, `standards/`, …).
...
See **`prompts/_shared/context-staging.md`** and **`workspace/knowledge/README.md`** (staging section).
