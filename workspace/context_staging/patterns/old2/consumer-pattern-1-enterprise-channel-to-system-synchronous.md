...
tags: integration, consumer, enterprise-channel, synchronous, reconciliation
related: []
---
...
- Implementation: Azure uses Service Bus, Azure Function, Azure Monitor, and a Reconciliation API.
