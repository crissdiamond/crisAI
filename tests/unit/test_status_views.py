...
def test_agent_icon_covers_known_types():
    assert status_views.agent_icon("orchestrator") == "🛰️"
    assert status_views.agent_icon("retrieval_planner") == "🔍"
    assert status_views.agent_icon("context_retrieval") == "📖"
    assert status_views.agent_icon("context_synthesizer") == "🧬"
    assert status_views.agent_icon("design_author") == "✍️"
    ...
    assert status_views.agent_icon("summary") == "📑"
    assert status_views.agent_icon("review") == "🔎"
    assert status_views.agent_icon("judge") == "🏛️"
    assert status_views.agent_icon("operations") == "🛠️"
