...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("/session new design-review-2", "session_new", "design-review-2", None),
        ("/session compact", "session_compact", None, None),
        ("/context show", "context_show", None, None),
        ("/context reset", "context_reset", None, None),
