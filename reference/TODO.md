...
- shared UI schemas, v1 runtime events, and initial React/Ink client scaffolds
  now exist, but the new clients still need parity and launch integration before
  replacing the current web UI and Textual Gem.
