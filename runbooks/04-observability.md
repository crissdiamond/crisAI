...
- `agent_trace.jsonl`: structured workflow events, readable stage outputs, deterministic retrieval metadata, retrieval checkpoint decisions, policy signals, peer decisions, and machine artifacts such as validated evidence bundles under event metadata.
