    ...
    *,
    ...
    blocks.extend(
        [
            ...
            "- When a required title phrase is given, instruct Context Retrieval to search that phrase **verbatim** "
            "(same words, same order) as the query — document search is word-order sensitive, so a reordered "
            "query returns different files.\n"
    ...
    *,
    ...
    blocks.extend(
        [
            ...
            "- **Search the required title phrase verbatim:** when a required title phrase is given, query the "
            "source with that phrase exactly as written — same words, same order. Do not reorder, split, or "
            "paraphrase it; document search is word-order sensitive, so a reordered query returns different "
            "files. You may run additional narrower queries afterwards, but the verbatim title phrase must be "
            "one of the queries you run.\n"
    ...
    *,
    ...
    blocks.extend(
        [
            ...
            "When a required title phrase is given, query the source with that phrase verbatim (same words, same order) — do not reorder or paraphrase it, since document search is word-order sensitive and a reordered query returns different files. "
