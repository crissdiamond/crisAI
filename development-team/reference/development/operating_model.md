...
in the target repository's normal Python and UI locations. Standing area Codex
agents are launched from the target repo root so their workspace-write sandbox
covers the files they own, while their role prompt and tmux label keep the area
boundary clear.
