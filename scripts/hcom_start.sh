...
if [[ "$CLAUDE_MODE" == "persistent" ]]; then
  name="$(launch_agent gem_claude "$REVIEWER_TOOL" crisai-gem . reference/development/roles/gem_claude.md gem)"
  LAUNCHED_NAMES+=("$name")
...
if [[ "$CLAUDE_MODE" == "persistent" ]]; then
  name="$(launch_agent web_claude "$REVIEWER_TOOL" crisai-web . reference/development/roles/web_claude.md web)"
  LAUNCHED_NAMES+=("$name")
...
if [[ "$CLAUDE_MODE" == "persistent" ]]; then
  name="$(launch_agent runtime_claude "$REVIEWER_TOOL" crisai-runtime . reference/development/roles/runtime_claude.md runtime)"
  LAUNCHED_NAMES+=("$name")
