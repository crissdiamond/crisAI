...
- Curated **knowledge corpus** file writes (if any) use **`workspace/knowledge_staging/`** per **`prompts/_shared/knowledge-staging.md`** unless the user explicitly requests **`knowledge/`** directly.
