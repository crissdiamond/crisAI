...
**Focus areas:** CLI behaviour; registry and prompts; MCP availability; workspace roots; **knowledge drafts** in `workspace/knowledge_staging/` vs approved `workspace/knowledge/`; SharePoint auth; env and startup scripts; logs and traces.
