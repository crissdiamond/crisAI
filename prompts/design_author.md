...
- Curated **knowledge corpus** file writes (if any) go to **`workspace/knowledge_staging/`** per **`prompts/_shared/knowledge-staging.md`** unless the user explicitly asks to write under **`knowledge/`** directly.
